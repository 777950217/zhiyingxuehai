    ...
    <div className="space-y-4">
      ...
      <div className="text-center pb-2">
        <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-full px-5 py-2">
          ...
          <span className="text-lg font-bold text-blue-900">专业概念卡</span>
          <span className="text-lg font-bold text-blue-700">：{data.name}</span>
        </div>
        <p className="text-sm text-gray-500 mt-2">先了解概念，再深入学习</p>
      </div>
      ...
      <div className="bg-orange-50 border border-orange-200 rounded-xl p-5">
        <div className="flex items-center gap-2 mb-2">
          <span className="text-2xl">💅</span>
          <h3 className="text-lg font-bold text-orange-900">装逼时刻</h3>
        </div>
