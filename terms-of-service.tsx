        ...
        <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8 space-y-8 text-gray-800 leading-relaxed text-[15px]">
          ...
          <section>
            ...
            <div className="space-y-3">
              ...
              <p><strong>1.2</strong> 平台分为个人版、专业版、旗舰版，各版本功能范围及对应价格以平台页面展示为准。用户购买相应版本后，在服务期内享有该版本对应功能的使用权。</p>
          ...
          <section>
            ...
            <div className="space-y-3">
              <p><strong>5.1 用户原因退款</strong>：根据《中华人民共和国消费者权益保护法》第二十五条规定，在线下载或者消费者拆封的音像制品、计算机软件等数字化商品不适用七天无理由退货。本平台提供的在线数字化服务属于此类商品，因用户自身原因（包括但不限于个人需求变化、学习时间不足、主观不满意等）申请退款的，一律不予退还。</p>
              <p><strong>5.2 平台问题退款</strong>：如因平台自身系统故障或服务质量问题导致用户无法正常使用核心功能，且经核实属于平台责任的，用户可申请按剩余服务天数等比例退还费用。退款金额 = 已支付金额 ×（剩余服务天数 / 总服务天数）。</p>
              <p><strong>5.3 服务到期</strong>：服务到期后，如用户未订阅，平台有权暂停该账号的付费功能使用权限，但不会删除用户的历史数据。用户可在重新订阅后恢复使用。</p>
              <p><strong>5.4 价格调整</strong>：订阅价格以订阅时平台页面展示的价格为准，平台有权根据运营成本调整价格，调整前已购买的套餐不受影响。</p>
            </div>
          </section>
