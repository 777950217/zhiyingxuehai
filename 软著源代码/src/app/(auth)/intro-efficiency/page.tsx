    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-blue-950 to-slate-900 text-white">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-cyan-500/10 border border-cyan-400/20 rounded-full mb-6">
          ...
          <span className="text-cyan-300 text-sm font-medium">99效率�?· 一线客服提效利�?/span>
        </div>
        <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6">
          不用学管�?span className="text-cyan-400">�?/span><br />
          只用借AI<span className="text-cyan-400">干活</span>
        </h1>
        <p className="text-lg text-white/60 max-w-2xl mx-auto mb-10">
          99�?年，AI急救站不限次+3项AI体检+话术练兵�?产品档案+模板�?
        </p>
        <Link
          href="/register?role=efficiency_user"
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        <h2 className="text-2xl font-bold text-center mb-10">你可能担心的三件�?/h2>
        <div className="grid gap-6 md:grid-cols-3">
          {[
            {
              icon: ShieldCheck,
              title: '不是试用、不是内测、不是精简体验�?,
              desc: '99�?年是独立正式版，完整功能、持续更新、独立服�?,
            },
            {
              icon: Zap,
              title: '无需强制开�?80',
            ...
            },
            {
              ...
              desc: '核心提效功能全部开放，AI急救站不限次、AI体检真实出结�?,
            },
          ].map((item) => (
            <div
              key={item.title}
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        ...
        <p className="text-center text-white/50 mb-10">每个场景，都有AI帮你3秒解�?/p>
        <div className="grid gap-5 md:grid-cols-2">
          {[
            {
              emoji: '🔥',
              pain: '加班写售后回复、反复改话术',
              solution: 'AI急救�?秒出专业话术',
              icon: Bot,
            },
            {
              emoji: '📝',
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/5 border border-amber-400/20 rounded-2xl p-8 md:p-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold">980是什么？</h2>
          </div>
          <p className="text-white/70 mb-4 text-lg">
            <span className="text-cyan-400 font-semibold">99帮你省时�?/span>�?span className="text-amber-400 font-semibold">980帮你学管�?/span>
          </p>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {[
              { icon: BookOpen, text: '25课管理课�? },
              { icon: BarChart3, text: 'KPI规划�? },
              { icon: ClipboardCheck, text: 'AI体检�?�? },
          ...
          <p className="mt-6 text-sm text-amber-300/70">
            想从一线晋升管理层�?80管理版等你开通，99年费可抵扣，实付881�?�?
          </p>
        </div>
      </section>
      ...
      {/* ── 第四屏：功能对比�?── */}
      <section className="max-w-4xl mx-auto px-6 pb-20">
        <h2 className="text-2xl font-bold text-center mb-10">99 vs 980 功能对比</h2>
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              {[
                ...
                { name: '话术练兵�?, free: true, pro: true },
                { name: '产品档案', free: true, pro: true },
                { name: '模板�?, free: true, pro: true },
                { name: '25课管理课�?, free: false, pro: true },
                { name: 'KPI规划�?, free: false, pro: true },
                { name: '周报月报复盘', free: false, pro: true },
                { name: '管理工具�?, free: false, pro: true },
              ].map((row) => (
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        <div className="bg-white/5 border border-white/10 border-dashed rounded-2xl p-10 text-center">
          ...
          <p className="text-white/30 text-lg font-medium mb-2">用户好评与数据背�?/p>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-10 text-center">
        ...
        <p className="text-white/50 mb-8">99�?�?· 独立正式�?· 无隐藏限�?/p>
        <Link
          href="/register?role=efficiency_user"
      ...
      <section className="max-w-4xl mx-auto px-6 pb-16">
        <h3 className="text-center text-white/50 text-sm mb-6">有任何问题？<a href="/contact" className="underline font-medium text-white/70 hover:text-white">添加微信咨询</a>，专属顾�?�?解答</h3>
        <div className="grid md:grid-cols-2 gap-4">
          {[
            { name: '效率�?, desc: '一线AI提效工具', href: '/register?role=efficiency_user', active: true },
            { name: '个人�?, desc: '团队管理训练�?, href: '/intro/personal' },
            { name: '专业�?, desc: '团队管理训练�?, href: '/intro/professional' },
            { name: '旗舰�?, desc: '陪跑式深度服�?, href: '/intro/flagship' },
          ].map((v) => (
            <Link
              key={v.name}
              href={v.href}
      ...
      <footer className="border-t border-white/10 py-8 text-center text-white/30 text-xs">
        ...
        <p className="mt-1">本平台不构成任何投资或法律建�?/p>
      </footer>
    </div>
  );
}
