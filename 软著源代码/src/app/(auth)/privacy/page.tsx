    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8 space-y-8 text-gray-800 leading-relaxed text-[15px]">
          {/* 第一�?*/}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">一、信息收集原�?/h2>
          ...
          <section>
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>昵称/显示名称：用于平台内身份展示与协�?/li>
                <li>用户自录入的工作数据：如员工信息、业绩数据、成本数据等，由用户自主录入，我们仅提供存储与展示服�?/li>
              </ul>
          ...
          {/* 第三�?*/}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">三、信息使用范�?/h2>
            <div className="space-y-3">
          ...
          {/* 第五�?*/}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">五、数据安全保�?/h2>
            <div className="space-y-3">
              <p>我们采取以下技术和管理措施保护您的数据安全�?/p>
              <ul className="list-disc pl-6 space-y-1">
                <li>全站HTTPS加密传输，保障数据传输安�?/li>
          ...
          {/* 第六�?- 更新：数据出境合规说�?*/}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">六、数据出境合规说�?/h2>
            <div className="space-y-3">
              ...
              <p><strong>6.2 出境目的与范�?/strong>：数据出境仅用于平台核心功能的存储与计算，包括课程学习记录、管理工具数据、账号信息等。我们不会将您的数据用于出境目的之外的其他用途�?/p>
              <p><strong>6.3 接收方安全认�?/strong>：数据出境的接收方为Supabase Inc.（supabase.com），其已获得以下安全认证与合规资质：</p>
              <ul className="list-disc pl-6 space-y-1">
          ...
          {/* 第七�?*/}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">七、用户数据权�?/h2>
            <div className="space-y-3">
              <p>您对您的个人信息享有以下权利�?/p>
              <ul className="list-disc pl-6 space-y-1">
                <li><strong>查看�?/strong>：您可随时在平台内查看您的个人资料和录入的数�?/li>
                <li><strong>导出�?/strong>：您可导出您在平台中录入的数据内�?/li>
                <li><strong>删除权与注销�?/strong>：您可申请删除个人信息或注销账号，具体操作路径为：登录后进入「个人中心」→「账号设置」→「注销账号」，我们将在15个工作日内完成处�?/li>
                <li><strong>撤回同意�?/strong>：您可随时撤回对个人信息处理的同意，撤回方式同上。撤回同意不影响撤回前基于您的同意已合法进行的个人信息处理活动的效力</li>
              </ul>
              <p><strong>无法删除的例外情�?/strong>：根据相关法律法规要求，部分信息在法定留存期限内无法删除，包括但不限于：</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>交易记录及财务相关信息（依法需保留不少�?年）</li>
                <li>网络安全日志信息（依法需保留不少�?个月�?/li>
              </ul>
          ...
          {/* 第八�?*/}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">八、团队数据说�?/h2>
            <div className="space-y-3">
              <p>对于企业版用户，团队数据管理遵循以下规则�?/p>
              <ul className="list-disc pl-6 space-y-1">
                <li>不同企业的数据严格私有隔离，企业间不可互�?/li>
                <li>企业管理员（主管/老板角色）仅能查看下属成员的学习进度汇总，无法查看成员具体录入的工作数据内�?/li>
          ...
          {/* 第九�?*/}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">九、未成年人保�?/h2>
            <div className="space-y-3">
              <p><strong>9.1</strong> 本平台面向成年工作者提供服务，不接受未�?8周岁的未成年人注册使用�?/p>
          ...
          {/* 第十�?- 更新：提�?天通知 */}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">十、政策更�?/h2>
            <div className="space-y-3">
              <p>我们可能适时修订本隐私政策。修订后的政策将在平台页面公布。对于重大变更（如信息收集范围扩大、数据出境安排变更等），我们将提�?天通过平台内通知或其他合理方式告知您，您有权在变更生效前选择是否继续使用本服务�?/p>
          ...
          {/* 第十一�?- 更新：联系邮�?*/}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">十一、联系渠�?/h2>
            <div className="space-y-3">
              <p>如您对本隐私政策有任何疑问或需要行使您的数据权利，可通过以下方式联系我们�?/p>
              <ul className="list-disc pl-6 space-y-1">
                <li>平台内帮助中心在线反�?/li>
                <li>电子邮箱�?051202571@qq.com</li>
              </ul>
              <p>我们将在收到您的请求�?5个工作日内予以回复和处理�?/p>
            </div>
          </section>
        </div>
