    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8 space-y-8 text-gray-800 leading-relaxed text-[15px]">
          {/* 第一章：服务说明 */}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">一、服务说�?/h2>
            <div className="space-y-3">
              <p><strong>1.1</strong> 本平台为线上知识学习与管理工具服务平台，由职盈学海（品牌�? 创始人（个人经营者）运营，向用户提供：在线课程、培训体系、实操模板、管理SOP、客服质检工具、KPI核算工具、排班工具、成本预警工具、AI辅助办公等线上数字化服务（以下统�?本服�?）�?/p>
          ...
          <section>
            ...
            <div className="space-y-3">
              ...
              <p><strong>2.3 服务可用�?/strong>：平台年可用率不低于99%，如因计划维护需暂停服务，我们将提前24小时通知用户�?/p>
              <p><strong>2.4 售后响应</strong>：我们提供售�?4小时响应服务，用户通过平台内帮助中心或联系邮箱提交的问题，将在24小时内获得初步响应�?/p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3">
              <p><strong>3.1 故障分级与修复时�?/strong>：平台对服务故障实行分级响应与修复机制：</p>
              <ul className="list-disc pl-6 space-y-1">
                <li><strong>一般故�?/strong>（部分功能异常但不影响核心使用）�?8小时内修�?/li>
                <li><strong>严重故障</strong>（核心功能不可用）：24小时内修�?/li>
                <li><strong>紧急故�?/strong>（全部服务不可用或数据安全风险）�?2小时内修�?/li>
              </ul>
              <p><strong>3.2 服务中断补偿</strong>：如因平台自身系统故障导致服务中断超过连�?2小时，用户可申请按剩余服务天数等比例延长服务期限。申请方式：通过平台内帮助中心或联系邮箱提交申请，我们将�?个工作日内核实并处理�?/p>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li><strong>个人�?/strong>：月度服务可用性不低于 <strong>95%</strong>，即每月累计不可用时长不超过36小时</li>
                <li><strong>专业�?/strong>：月度服务可用性不低于 <strong>98%</strong>，即每月累计不可用时长不超过14.4小时</li>
                <li><strong>旗舰�?/strong>：月度服务可用性不低于 <strong>99%</strong>，即每月累计不可用时长不超过7.2小时</li>
              </ul>
              <p>服务可用性计算方式：月度可用�?=（月总分钟数 - 非计划停机分钟数�? 月总分钟数 × 100%。计划维护窗口不计入不可用时长。如未达到对应版本SLA承诺，用户可按本协议第三条第3.2款申请等比例延长服务期限�?/p>
            </div>
          </section>
          ...
          {/* 第五章：付费与退款（重写�?*/}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">五、付费与退�?/h2>
            <div className="space-y-3">
              <p><strong>5.1 用户原因退�?/strong>：根据《中华人民共和国消费者权益保护法》第二十五条规定，在线下载或者消费者拆封的音像制品、计算机软件等数字化商品不适用七天无理由退货。本平台提供的在线数字化服务属于此类商品，因用户自身原因（包括但不限于个人需求变化、学习时间不足、主观不满意等）申请退款的，一律不予退还�?/p>
              <p><strong>5.2 平台问题退�?/strong>：如因平台自身系统故障或服务质量问题导致用户无法正常使用核心功能，且经核实属于平台责任的，用户可申请按剩余服务天数等比例退还费用。退款金�?= 已支付金�?×（剩余服务天�?/ 总服务天数）�?/p>
              <p><strong>5.3 服务到期</strong>：服务到期后，如用户未订阅，平台有权暂停该账号的付费功能使用权限，但不会删除用户的历史数据。用户可在重新订阅后恢复使用�?/p>
              <p><strong>5.4 价格调整</strong>：订阅价格以订阅时平台页面展示的价格为准，平台有权根据运营成本调整价格，调整前已订阅的套餐不受影响�?/p>
            </div>
          </section>
          ...
          {/* 第七章：用户禁止行为 */}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">七、用户禁止行�?/h2>
            <div className="space-y-3">
          ...
          <section>
            ...
            <div className="space-y-3">
              ...
              <p><strong>8.4 第三方原因免�?/strong>：本平台可能包含指向第三方网站或服务的链接，用户访问第三方内容的风险由用户自行承担。因第三方服务变更、中断或数据泄露等导致的损失，平台不承担责任，但将在知悉后及时提醒用户�?/p>
              <p><strong>8.5 服务保障承诺</strong>：平台将持续优化技术架构和运维体系，尽力保障服务稳定运行，但不对服务绝对无中断、无故障做承诺。如因平台自身系统故障导致服务中断超过连�?2小时，用户可按本协议第三条第3.2款申请等比例延长服务期限�?/p>
          ...
          {/* 第九章：知识产权说明 */}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">九、知识产权说�?/h2>
            <div className="space-y-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">十、协议变更规�?/h2>
            <div className="space-y-3">
              <p>服务方有权根据法律法规变化、业务发展需要等原因对本协议进行修订。修订后的协议将在平台页面公布�?/p>
              <p>对于重大变更（如服务内容调整、费用结构变更、责任条款修改等），我们将提�?天通过平台内通知或其他合理方式告知您，您有权在变更生效前选择是否继续使用本服务�?/p>
          ...
          {/* 第十一章：争议解决 */}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">十一、争议解�?/h2>
            <div className="space-y-3">
          ...
          {/* 第十二章：联系方式（更新：邮箱） */}
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">十二、联系方�?/h2>
            <div className="space-y-3">
