...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('[API] GET /phrases error:', err);
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Audit log
    await logAction({
      userId: body.created_by || 'unknown',
    ...
    console.error('[API] POST /phrases error:', err);
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error('[API] PUT /phrases error:', err);
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error('[API] DELETE /phrases error:', err);
